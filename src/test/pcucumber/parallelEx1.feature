Feature: Example 1 with parallel Cucumber
...
Scenario Outline: Ex1
    ...
    And Student S4 enters select course <option3> option and <course code>
    When Student S2 enters register course <option4> option and <course code>
